...
// import { MutableObservableValue } from '@theia/test/lib/common/observableValue'
// import { ExtensionRunTestsRequest, IFileCoverage, ITestItem, ITestMessage, ITestRunProfile, ITestRunTask, ResolvedTestRunRequest, TestResultState, TestsDiffOp } from '@theia/test/lib/common/test-types';
// import { TestCoverage } from '@theia/test/lib/common/testCoverage'
// import { ITestProfileService } from '@theia/test/lib/common/testProfileService';

// // TODO: test: configure imports below this line. Imports over it seems functional.
...
//      * @inheritdoc
//      */
//     public $appendOutputToRun(runId: string, taskId: string, output: BinaryBuffer, locationDto?: ILocationDto, testId?: string): void {
